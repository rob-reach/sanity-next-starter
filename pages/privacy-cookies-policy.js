...
const PrivacyCookiesPolicy = () => {
    return (
        <MainLayout>
            <Head>
                <title>Reach Next Js Starter - Cookies Policy</title>
            ...
            <div className="container py-8">
                <main>
                    <div className="text-container">
                        ...
                        <p>
                            We are committed to protecting your privacy. We value our visitors and endeavour to create an enjoyable and safe shopping experience when visiting our website.
                        </p>
                        <p>
                        ...
                        <nav>
                            <ul className="pl-5 my-4 list-disc">
                                ...
                                <li>
                                    <a href="#five">Your consent for cookie deployment by our website</a>
                                </li>
                                <li>
                        ...
                        <section id="one">
                            ...
                            <p>
                                When making an enquiry through a form on our website, we may collect the following information. Your name and appropiate contact information including email address, address, preferences and interests. Other information relevant to the purpose of your enquiry may also be requested.
                            </p>
                            ...
                            <table className="table-auto w-full my-8">
                                ...
                                <tbody>
                                    ...
                                    <tr className="border-b-[1px]">
                                        ...
                                        <td>__{process.env.NEXT_PUBLIC_SITE_NAME}_cookies_accepted</td>
                                        <td>Used to remember if you have seen the cookies banner or not.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </section>
                        ...
                        <section id="seven">
                            ...
                            <p>
                                Most modern browsers allow you to control your cookie settings for all websites that you browse. You can disable cookie deployment completely by editing your browser settings, however in doing this you may be limiting the functionality that is displayed on our website. To learn how to disable cookies on your preferred browser we recommend reading <a href="https://support.google.com/accounts/answer/61416?hl=en" target="_blank" rel="noopener noreferrer">this advice posted by Google.</a>
                            </p>
                            <p>
                                If you are concerned about cookies tracking your movements on the Internet then you may be concerned about spyware. Spyware is the name given to a particular band of cookies that track personal information about you. There are many antispyware programs that you can use to prevent this from happening. Learn more about antispyware software - <a href="https://en.wikipedia.org/wiki/Spyware" target="_blank" rel="noopener noreferrer">https://en.wikipedia.org/wiki/Spyware</a>. You call also disable Google Analytics on all websites by downloading the <a href="https://support.google.com/analytics/answer/181881" target="_blank" rel="noopener noreferrer">Google Analytics Opt-out Browser Add-on</a>.
                            </p>
                        </section>
                    </div>
                </main>
